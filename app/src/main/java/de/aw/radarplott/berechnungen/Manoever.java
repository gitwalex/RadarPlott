...
public class Manoever extends Lage {
     ...
     */
    public Manoever(Lage lage, float neuerkurs, float manoeverminuten,
                    float fahrt) {
        ...
        eEigKurs = neuerkurs;
        eEigFahrt = fahrt;
        pos1_a = new Punkt2D((float) -(fahrt / (60 / eIntervall) * Math.sin(Math
                .toRadians(neuerkurs))), (float)
        ...
        eDistanz1 = pos0_b.getDistance(pos1_a);
        rasp1 = pos1_a.getPeilung(pos0_b);
        pos1_b = pos2_a.getPunkt(eDistanz1, rasp1);
        berechneKurslinien(eIntervall);
        b3 = new Kurslinie(lage.b2.getAktuellerStandort(), b2.getRichtungsvektor(),
                lage.eEigFahrt);
        oldLage = lage;
    }
