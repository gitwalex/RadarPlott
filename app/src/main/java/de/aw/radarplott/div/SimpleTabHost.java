...
public class SimpleTabHost extends Fragment implements OnTabChangeListener,
	 ...
	 * @see #maxTabs
	 */
	public static final String TAB1 = "TAB1", TAB2 = "TAB2", TAB3 = "TAB3", TAB4 = "TAB4", TAB5 =
			"TAB5", TAB6 = "TAB6", TAB7 = "TAB7", TAB8 = "TAB8", TAB9 = "TAB9", TAB10 = "TAB10";
	/**
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (!setNumberOfPagesCalled) {
			throw new IllegalArgumentException(getActivity()
					.toString() + " hat nicht setNumberOfPages(numberOfPages) gerufen!");
		}
	...
	public void removeTab(int tabIndex) {
		mTabHost.getTabWidget().removeView(mTabHost.getTabWidget().getChildTabViewAt(tabIndex));
	}
	...
	public void setNumberOfPages(int numberOfPages) {
		...
		if (numberOfPages > maxTabs) {
			throw new IllegalArgumentException(
					getActivity().toString() + " darf nicht mehr als " + maxTabs + " erwarten!.");
		}
	...
	public interface TabCreator {
		TabSpec getNewTab(SimpleTabHost mTabHost, int tabNumber);

		void onTabSelected(String tabId);

		void updateTab(View view, String tabId, int placeholder);
	}
}
