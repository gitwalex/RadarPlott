...
public class MaxInhaltTextWatcher implements TextWatcher {
    ...
    private float[] maxeditvalue = {360f, 100f, 100f, 360f, 360f, 360f, 100f,
            360f, 360f, 360f, 100f};
    private float maxinhalt;
    ...
    public interface ErgebnisListener {
        void onEigenerKursChanged(float wert);

        void setError(EditText et, float maxinhalt);

        void setWertNOK(String fragmentId, int index);

        void setWertOK(String fragmentId, int index, float value);
    }
}
