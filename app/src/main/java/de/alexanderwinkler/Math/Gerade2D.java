 ...
 */
public class Gerade2D implements Parcelable {
    /**
     *
     */
    ...
    private Gerade2D(Punkt2D von, Punkt2D nach, Vektor2D richtung) {
        if (von.equals(nach)) {
            Log.d(LOGTAG,
                    "Fehler bei Gerade(Punkt von, Punkt nach, Vektor richtung), Parameter: " + von
                            .toString() + " / " + nach.toString() + " / " + richtung.toString());
    ...
    protected Gerade2D(Parcel in) {
        this.punkt1 = in.readParcelable(Punkt2D.class.getClassLoader());
    ...
    /**
     * Ermittelt den Abstand zweier Punkte auf der Geraden. Liegt einer der Punkte nicht auf der
     * Geraden, wird Double.NaN zurueckgegeben
     *
     * @param p
    ...
    public String toString() {
        ...
        return ("Geradengleichung: " + a + " x  + " + b + " y + " + c + " = 0\nPunkt: " + punkt1
                .toString() + "Normalenvektor: " + getNormalenvektor()
                .toString() + ", Richtungsvektor: " + rv.toString() + "\nm = " + rundeWert(
                m) + ", n = " + rundeWert(n) + "(y= " + rundeWert(m) + " x " + rundeWert(n) + ")");
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeParcelable(this.punkt1, flags);
        dest.writeParcelable(this.punkt2, flags);
        dest.writeParcelable(this.rv, flags);
        dest.writeParcelable(this.nv, flags);
