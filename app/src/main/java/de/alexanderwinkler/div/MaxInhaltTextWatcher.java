...
public class MaxInhaltTextWatcher implements TextWatcher {
	...
	public interface ErgebnisListener {
		public void onEigenerKursChanged(double wert);
	...
	/**
	 * Konstruktor fuer TextWatcher. Muss als einzelne Instanz an ein
	 * EditText-Feld gehaengt werden.
	 * 
	 * @param editText
	 *            EditText-Feld, welches inhaltlich ueberprueft wird
	 * @param index
	 *            Index in maxeditvalue. Wird auch benutzt, um das Flag dero
	 *            ordentlichen Eingabe zu setzen.
	 */
	public MaxInhaltTextWatcher(ErgebnisListener el, String fragmentId,
			EditText editText, int index) {
		// Parameter merken
